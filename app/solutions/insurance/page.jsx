...
export default function Insurance() {
  return (
    <section className="flex flex-col items-center justify-center">
      ...
      <div className="pt-10 sm:pt-0 text-[30px] sm:text-[50px] md:text-[55px] text-center leading-[40px] sm:leading-[55px] md:leading-[68px] mt-16 sm:mt-24 md:mt-32 h-auto">
